document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderAnswers = () => {
        const questionData = data.canvas2[currentIndex]; // Получаем данные текущего вопроса
        ...
        canvas.innerHTML = `
            <div class='canvas2'>
                ...
                <div class='progress'>
                    ...
                    <button id='backButton' style='${currentIndex === 0 ? 'display: none;' : 'display: block;'}'>Назад</button>
    ...
    const renderCanvas = () => {
        ...
        quiz.innerHTML = `
            <div>
                ...
                <div id='canvas' class='${data.theme.button_style}'></div>
            </div>
        `;            
