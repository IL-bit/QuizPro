      ...
      <div className="container p-3">
        <header className="row" id="header">
          ...
          <div className="col-xxl-7 col-xl-7 col-lg-7 col-7">
            ...
            <button className="create" title="Создать новый квиз"  onClick={() => {isAuth ? window.location.href = 'http://quizforbiz.ru:90': handleToggle('log_in')}}>Создать квиз</button>                
          </div>
          <div className="col-xxl-3 col-xl-3 col-lg-3 col-2">
              <div className="buttons">
                  ...
                  <button title="Создать новый квиз"    onClick={() => {isAuth ? window.location.href = 'http://quizforbiz.ru:90': handleToggle('log_in')}}>Создать квиз</button>
              </div>                               
          </div>
        ...
        <main>
          <section className="row" id="first_section" aria-labelledby="section1-heading">
            <div className="col-xxl-8 col-12 mx-auto">
              ...
              <button aria-label="Попробовать бесплатно" onClick={() => {isAuth ? window.location.href = 'http://quizforbiz.ru:90': handleToggle('log_in')}}>попробовать бесплатно</button>
            </div>
          </section>    
          ...
          <section className="row" id="seventh_section" aria-labelledby="section7-title">
            <div className="col-xxl-12 col-xl-12 col-lg-12 col-12">
                ...
                <Section7 />
                <div className="more_funct" id="pc" onClick={() => {isAuth ? window.location.href = 'http://quizforbiz.ru:90': handleToggle('log_in')}}>
                  <Image src={cursor} alt="Иконка курсора"/>
                    <p>Смотреть больше квизов</p>
                </div>
                <div className="more_funct" id="mob" onClick={() => {isAuth ? window.location.href = 'http://quizforbiz.ru:90': handleToggle('log_in')}}>
          ...
          <section id="twelvth_section" className='row'>
            ...
            <div className="col-xxl-4 col-xl-4 col-lg-4 col-12 text-center">
                <div className="price price-1">
                    ...
                    <button onClick={() => {isAuth ? window.location.href = 'http://quizforbiz.ru:90': handleToggle('log_in')}}>Подключить</button>
                </div>
            </div>
            <div className="col-xxl-4 col-xl-4 col-lg-4 col-12 text-center">
          ...
          <section className="row" id="ninth_section" aria-labelledby="section9-title">
            ...
            <div className="col-xxl-5 col-xl-5 col-lg-6 offset-xxl-1 offset-xl-0 offset-lg-0 pc">
                ...
                <button title="Попробовать бесплатно" aria-label="Попробовать Quiz Pro бесплатно" onClick={() => {isAuth ? window.location.href = 'http://quizforbiz.ru:90': handleToggle('log_in')}}>попробовать бесплатно</button>
            </div>
            <div className="col-12 mob">
                ...
                <div className="pc">
                  <div className="cards">
                      <article className="card" aria-labelledby="card-title-1">
                          ...
                          <button title="Смотреть квиз" aria-label="Смотреть квиз Быстрый опросник" onClick={() => {isAuth ? window.location.href = 'http://quizforbiz.ru:90' : handleToggle('log_in')}}>Смотреть квиз</button>
                      </article>
                      <article className="card" aria-labelledby="card-title-2">
                          ...
                          <button title="Смотреть квиз" aria-label="Смотреть квиз Страница о компании" onClick={() => {isAuth ? window.location.href = 'http://quizforbiz.ru:90' : handleToggle('log_in')}}>Смотреть квиз</button>
                      </article>
                      <article className="card" aria-labelledby="card-title-3">
                          ...
                          <button title="Смотреть квиз" aria-label="Смотреть квиз Магазин" onClick={() => {isAuth ? window.location.href = 'http://quizforbiz.ru:90' : handleToggle('log_in')}}>Смотреть квиз</button>
                      </article>
                  </div>
                  <div className="cards">
                      <article className="card" aria-labelledby="card-title-4">
                          ...
                          <button title="Смотреть квиз" aria-label="Смотреть квиз Калькулятор" onClick={() => {isAuth ? window.location.href = 'http://quizforbiz.ru:90' : handleToggle('log_in')}}>Смотреть квиз</button>
                      </article>
                      <article className="card" aria-labelledby="card-title-5">
                          ...
                          <button title="Смотреть квиз" aria-label="Смотреть квиз Видео-консультант" onClick={() => {isAuth ? window.location.href = 'http://quizforbiz.ru:90' : handleToggle('log_in')}}>Смотреть квиз</button>
                      </article>
                      <article className="card" aria-labelledby="card-title-6">
